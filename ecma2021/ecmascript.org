...
*** 8.1.3 静态语法：IsConstantDeclaration
LexicalDeclaration : LetOrConst BindingList ;
...
*** 8.1.4 静态语法：LexicallyDeclaredNames
Block : { }
    1. 返回新的空List
StatementList : StatementList StatementListItem
*** 8.1.5 静态语法：LexciallyScopedDeclarations
* 25
** 25.1
